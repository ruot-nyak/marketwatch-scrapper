...
r = requests.get("https://www.marketwatch.com/investing/stock/gm/analystestimates?mod=mw_quote_tab")
...
class bot:
    ...
    def return_current_price(self,current_price):
        ...
        print(f'The current value of GM is, ${self.current_price[1]}')
